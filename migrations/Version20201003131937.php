 ...
 */
final class Version20201003131937 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tour_operator ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tour_operator DROP email, DROP password');
